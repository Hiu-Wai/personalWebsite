    ...
    <div class="cover-container d-flex vw-100 vh-90 p-3 mx-auto flex-column">
      <div class="d-flex justify-content-center">
        <div id="carouselExampleIndicators" class="carousel slide bg-dark" data-bs-ride="carousel"
            ...
            <div class="carousel-item">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    class="bi bi-journal-code me-2" viewBox="0 0 16 16">
                  ...
                  <div class="justify-content-between">
                    <div class="button-group mt-4">
                      <a v-for="button in project.buttons" :key="button.text" :href="button.hyperlink"
          ...
          <button class="carousel-control-prev justify-content-between custom-prev" style="padding-left: 30px"
            type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
          </button>
          <button class="carousel-control-next justify-content-between custom-next" style="right:-80px" type="button"
