<template>
    ...
    <div id="carouselExampleIndicators" class="carousel slide bg-dark" data-bs-ride="carousel" style = "width: 75%; border-radius: 10px;">
      ...
      <div class="carousel-inner align-items-center">
        <div class="carousel-item active">
          <div class = "row">
            <div class="col-md-7">
              ...
              <br>
              <p>Holystic is a website built for the UCL AI Hackathon 2024 with Holistic AI. The website aims to provide different AI models
                for the client to decide whether they can take a loan. It also states the benefits and disadvantages of each AI model so that
                the user is more aware of the impacts for each.
              </p>
            </div>
            <div class="col-md-4">
              <div class = "image-wrapper">
                <img src = "images\holystick_logo.png" class = "img-fluid">
              </div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class = "row">
            <div class="col-md-6">
              <h1>HolyStick</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-translate me-2" viewBox="0 0 16 16">
                  <path d="M4.545 6.714 4.11 8H3l1.862-5h1.284L8 8H6.833l-.435-1.286zm1.634-.736L5.5 3.956h-.049l-.679 2.022z"/>
                  <path d="M0 2a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v3h3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zm7.138 9.995q.289.451.63.846c-.748.575-1.673 1.001-2.768 1.292.178.217.451.635.555.867 1.125-.359 2.08-.844 2.886-1.494.777.665 1.739 1.165 2.93 1.472.133-.254.414-.673.629-.89-1.125-.253-2.057-.694-2.82-1.284.681-.747 1.222-1.651 1.621-2.757H14V8h-3v1.047h.765c-.318.844-.74 1.546-1.272 2.13a6 6 0 0 1-.415-.492 2 2 0 0 1-.94.31"/>
                </svg>
                <span>Techniques used: Python, flask, Vue, Bootstrap, AI, ML</span>
                <br>
                ...
                <span>Takeaways: Learnt how to use flask for the first type</span>
                <br>
                ...
                <span>Note: Data used for this website is based on database provided, might not reflect reality.</span>
                <div class="justify-content-between">
                  <a href="https://holystick.dylankainth.com/" class="btn btn-lg btn-primary m-2">Visit project deployment</a>
                  <a href="https://github.com/dylankainth/holystick" class="btn btn-lg btn-primary m-2">Visit Github for project</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class = "image-wrapper">
      ...
      <button class="carousel-control-prev justify-content-between custom-prev" style = "padding-left: 30px" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
      </button>
      <button class="carousel-control-next justify-content-between custom-next" style = "right:-80px"type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
