      ...
      <div class="carousel-item active">
        <div class = "row">
          <div class="col-md-7">
            ...
            <br>
            <p>FashTrack is a website built in Culturehack 2024 that aims to ease the job application process in the fashion industry. 
              It contains a job tracker which displays the jobs available at the momenet. It also has a mentorship hub that gives the 
              opportunity for users to interact with professionals in the industry. </p>
          </div>
          <div class="col-md-4">
            <div class = "image-wrapper">
              <img src = "images\fashtrack_logo.png" class = "img-fluid">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class = "row">
          <div class="col-md-6">
            ...
            <div class = "d-flex align-items-center">
              ...
              <span>Techniques used: Nuxt, Vue, Bootstrap, MongoDB</span>
            </div>
              ...
              <span>Takeaways: Learnt about Nuxt, Vue and Bootstrap and used these for the first time.</span>
              <br>
